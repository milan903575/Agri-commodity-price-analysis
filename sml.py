...
file_path = 'C:/xampp/htdocs/ap/pro1/stored.txt'  # Replace with the actual file path
...
weather = pd.read_csv('C:/xampp/htdocs/ap/pro1/IndianWeatherRepository.csv')
rain = pd.read_csv('C:/xampp/htdocs/ap/pro1/district wise rainfall normal.csv')
recomm = pd.read_csv('C:/xampp/htdocs/ap/pro1/crop_recommendation.csv')
soil = pd.read_csv('C:/xampp/htdocs/ap/pro1/soil.csv')
sr = pd.read_csv('C:/xampp/htdocs/ap/pro1/sr.csv')
...
district = stored_variable.upper()
...
k={'Soil':soil_type_str,'Temp':temperature,'Rain':rainfall,'Humidity':humidity,'Crops':recommended_crop}
m={'State':s1,'District':district}
print(k,m)


with open('C:\\xampp\\htdocs\\ap\\pro1\\k.json', 'w') as file:
    json.dump(k, file)
    
    
with open('C:\\xampp\\htdocs\\ap\\pro1\\m.json', 'w') as file:
    json.dump(m, file)